...
After :: \B C y e. exists z .(C(after:1(e, y)) & C(after:2(e, z)) & C(y) & B(z))
Agent :: \x.(EQUAL(x, agent))
Air :: \x.(EQUAL(x, air))
Although :: \B C y e. exists z .(C(although:1(e, y)) & C(although:2(e, z)) & C(y) & B(z))
...
Army :: \x.(EQUAL(x, army))
As :: \B C y e. exists z .(C(as:1(e, y)) & C(as:2(e, z)) & C(y) & B(z))
...
Bath :: \x.(bath(x))
Before :: \B C y e. exists z .(C(before:1(e, y)) & C(before:2(e, z)) & C(y) & B(z))
Bel :: \x.(EQUAL(x, bel))
...
Despite :: \B C y e. exists z .(C(despite:1(e, y)) & C(despite:2(e, z)) & C(y) & B(z))
...
During :: \B C y e. exists z .(C(during:1(e, y)) & C(during:2(e, z)) & C(y) & B(z))
...
From :: \B C y e. exists z .(C(from:1(e, y)) & C(from:2(e, z)) & C(y) & B(z))
GPS :: \x.(EQUAL(x, gps))
...
Since :: \B C y e. exists z .(C(since:1(e, y)) & C(since:2(e, z)) & C(y) & B(z))
...
Throughout :: \B C y e. exists z .(C(throughout:1(e, y)) & C(throughout:2(e, z)) & C(y) & B(z))
Time :: \x.(time(x))
...
While :: \B C y e. exists z .(C(while:1(e, y)) & C(while:2(e, z)) & C(y) & B(z))
...
aboard :: \B C y e. exists z .(C(aboard:1(e, y)) & C(aboard:2(e, z)) & C(y) & B(z))
about :: \B C y e. exists z .(C(about:1(e, y)) & C(about:2(e, z)) & C(y) & B(z))
accept :: \B C e. exists y z .(accept:1(e, y) & accept:2(e, z) & C(y) & B(z))
access :: \x.(access(x))
across :: \B C y e. exists z .(C(across:1(e, y)) & C(across:2(e, z)) & C(y) & B(z))
act :: \x.(act(x))
...
against :: \B C y e. exists z .(C(against:1(e, y)) & C(against:2(e, z)) & C(y) & B(z))
age :: \x.(age(x))
agent :: \x.(agent(x))
ago :: \B C y e. exists z .(C(ago:1(e, y)) & C(ago:2(e, z)) & C(y) & B(z))
...
am :: \P x.(P(x))
among :: \B C y e. exists z .(C(among:1(e, y)) & C(among:2(e, z)) & C(y) & B(z))
amount :: \x.(amount(x))
amputee :: \x.(amputee(x))
an :: None
and :: \P Q x.(P(x) & Q(x))
...
because :: \B C y e. exists z .(C(because:1(e, y)) & C(because:2(e, z)) & C(y) & B(z))
...
best :: \P x.(P(best(x)) & P(x))
between :: \B C y e. exists z .(C(between:1(e, y)) & C(between:2(e, z)) & C(y) & B(z))
big :: \P x.(P(big(x)) & P(x))
bills :: \x.(bills(x))
...
husband :: \x.(husband(x))
idea :: \x.(idea(x))
if :: \B C y e. exists z .(C(if:1(e, y)) & C(if:2(e, z)) & C(y) & B(z))
...
instead :: \B C y e. exists z .(C(instead:1(e, y)) & C(instead:2(e, z)) & C(y) & B(z))
...
into :: \B C y e. exists z .(C(into:1(e, y)) & C(into:2(e, z)) & C(y) & B(z))
...
names :: \x.(names(x))
nation :: \x.(nation(x))
near :: \B C y e. exists z .(C(near:1(e, y)) & C(near:2(e, z)) & C(y) & B(z))
nearby :: \P x.(P(nearby(x)) & P(x))
nearest :: \B C y e. exists z .(C(nearest:1(e, y)) & C(nearest:2(e, z)) & C(y) & B(z))
new :: \P x.(P(new(x)) & P(x))
news :: \x.(news(x))
...
officer :: \x.(officer(x))
old :: \P x.(P(old(x)) & P(x))
older :: \P x.(P(older(x)) & P(x))
oldest :: \P x.(P(oldest(x)) & P(x))
on :: \B C y e. exists z .(C(on:1(e, y)) & C(on:2(e, z)) & C(y) & B(z))
onboard :: \x.(onboard(x))
one :: \x.(EQUAL(x, one))
...
outside :: \B C y e. exists z .(C(outside:1(e, y)) & C(outside:2(e, z)) & C(y) & B(z))
over :: \B C y e. exists z .(C(over:1(e, y)) & C(over:2(e, z)) & C(y) & B(z))
...
though :: \B C y e. exists z .(C(though:1(e, y)) & C(though:2(e, z)) & C(y) & B(z))
...
to :: \B C y e. exists w .(C(to:2(e, w)) & C(y) & B(w))
to :: \P Q x.(P(x) & Q(x))
...
until :: \B C y e. exists z .(C(until:1(e, y)) & C(until:2(e, z)) & C(y) & B(z))
...
without :: \B C y e. exists z .(C(without:1(e, y)) & C(without:2(e, z)) & C(y) & B(z))
women :: \x.(women(x))
...
PP/NP :: \B C y e. exists w .(to:1(e, y) & C({0}:2(e, w)) & C(y) & B(w))
(N\N)/N :: \P Q x.(P(x) & Q(x))
(S/S)/S :: \B C y e. exists z .(C({0}:1(e, y)) & C({0}:2(e, z)) & C(y) & B(z))
...
(S\NP)/NP :: \P x.(P({0}(x)) & P(x))
PP/(S\NP) :: \B C y e. exists z .(C({0}:1(e, y)) & C({0}:2(e, z)) & C(y) & B(z))
PP/(S\NP) :: \B C y e. exists w .(to:1(e, y) & C({0}:2(e, w)) & C(y) & B(w))
(NP/N)\NP :: \B C e. exists y z .({0}:1(e, y) & {0}:2(e, z) & C(y) & B(z))
(NP\NP)/NP :: \B C y e. exists z .(C({0}:1(e, y)) & C({0}:2(e, z)) & C(y) & B(z))
(NP\NP)/NP :: \B C y e. exists w .(to:1(e, y) & C({0}:2(e, w)) & C(y) & B(w))
(NP\NP)/NP :: \B C e. exists y z .({0}:1(e, y) & {0}:2(e, z) & C(y) & B(z))
(N/N)\(N/N) :: \P x.(P({0}(x)) & P(x))
(S/S)/(S\NP) :: \B C y e. exists z .(C({0}:1(e, y)) & C({0}:2(e, z)) & C(y) & B(z))
((S/S)/PP)/NP :: \B C y e. exists z .(C({0}:1(e, y)) & C({0}:2(e, z)) & C(y) & B(z))
...
(S\NP)/(S\NP) :: \P x.(P(x))
(S\NP)/(S\NP) :: \P Q e. exists x.(NEGATION(e) & P(e,x) & Q(x))
(S\NP)/(S\NP) :: \B C y e. exists w .(to:1(e, y) & C({0}:2(e, w)) & C(y) & B(w))
...
(NP\NP)\(NP\NP) :: \x.(EQUAL(x, {0}))
(NP\NP)\(NP\NP) :: \P x.(COUNT(x, {0}) & P(x))
((N/N)\(N/N))/NP :: \B C y e. exists z .(C({0}:1(e, y)) & C({0}:2(e, z)) & C(y) & B(z))
((S\NP)\(S\NP))/S :: \B C y e. exists z .(C({0}:1(e, y)) & C({0}:2(e, z)) & C(y) & B(z))
...
((S\NP)\(S\NP))/PP :: \B C y e. exists z .(C({0}:1(e, y)) & C({0}:2(e, z)) & C(y) & B(z))
((S\NP)\(S\NP))/NP :: \B C y e. exists z .(C({0}:1(e, y)) & C({0}:2(e, z)) & C(y) & B(z))
((S\NP)\(S\NP))/NP :: \B C y e. exists w .(to:1(e, y) & C({0}:2(e, w)) & C(y) & B(w))
((S\NP)\(S\NP))/NP :: \P x.(P({0}(x)) & P(x))
((S\NP)\(S\NP))/(S/NP) :: \P. exists x.(TARGET(x) & P(x))
((S\NP)\(S\NP))/(S/NP) :: \P Q x. exists e.(P(x,e) & Q(x))
((S\NP)\(S\NP))/(S\NP) :: \B C y e. exists z .(C({0}:1(e, y)) & C({0}:2(e, z)) & C(y) & B(z))
(((S\NP)\(S\NP))/(S\NP))/NP :: \B C y e. exists z .(C({0}:1(e, y)) & C({0}:2(e, z)) & C(y) & B(z))
((S\NP)\(S\NP))/((S\NP)\(S\NP)) :: \x.(EQUAL(x, {0}))
((S\NP)\(S\NP))/((S\NP)\(S\NP)) :: \P x.(COUNT(x, {0}) & P(x))
(((S\NP)\(S\NP))/((S\NP)\(S\NP)))/NP :: \B C y e. exists z .(C({0}:1(e, y)) & C({0}:2(e, z)) & C(y) & B(z))
