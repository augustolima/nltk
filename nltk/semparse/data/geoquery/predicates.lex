...
How :: ((S/(S\N))/N)/(N/N) :: \P x.(degree:1(d, x) & degree:2(d, P) & TARGET(x))
How :: ((S/(S/N))/N)/(N/N) :: \P x.(P(x) & TARGET(x))
"How :: (S/(S/(S\N)))/(S\N) :: \P x.(P(x) & TARGET(x))
How :: (S/(S/(S\N)))/(S\N) :: \P x.(degree:1(d, x) & degree:2(d, P) & TARGET(x))
...
In :: (S/(S/N))/(S/(S/N)) :: \P Q Y.exists y w z.(P(y) & Q(w,z) & in:1(y,w) & in:2(y,z) & in:3(y,y))
In :: (S/(S/PP))/(S/(S/N)) :: \P Q e.exists w z y.(P(w) & Q(z,y) & in:1(e,z) & in:2(e,y) & in:3(e,w))
...
Texas :: N/N :: \x.EQUAL(x,texas)
Through :: (S/(S/PP))/(S/(S/N)) :: \P Q e.exists w z y.(P(w) & Q(z,y) & through:1(e,z) & through:2(e,y) & through:3(e,w))
...
are :: (S\N)/N :: \P x.P(x)
are :: (S/(S\N))/N :: \P Q e.exists z y.(P(z) & Q(z,y) & are:1(e,z) & are:2(e,y))
...
area :: N :: \x.area(x)
at :: ((N/N)/(N/N))/(S\N) :: \P Q R y.exists v w.(P(v,w) & Q(y,y) & R(y) & at:1(y,y) & at:2(y,v) & at:3(y,w))
...
does :: (S\N)/(S\N) :: \P Q e.exists y z.(P(y,z) & Q(y) & does:1(e,y) & does:2(e,z))
does :: (S/(S\N))/N :: \P Q e.exists z y.(P(z) & Q(z,y) & does:1(e,z) & does:2(e,y))
...
is :: (S/(S\N))/N :: \P Q e.exists z y.(P(z) & Q(z,y) & is:1(e,z) & is:2(e,y))
...
least :: (N/N)/(N/N) :: \P Q y.(P(y,y) & Q(y) & least(y))
length :: N :: \x.length(x)
level :: N :: \x.level(x)
...
no :: ((S\N)\(S\N))/N :: \P Q R y.exists w z.(P(w) & Q(z,y) & R(z) & COMPLEMENT(y))
...
runs :: N :: \x.runs(x)
s :: ((S/(S\N))/N)\(S/(S\N)) :: \P Q R Y.exists y v w z.(P(y) & Q(v) & R(w,z) & _s:1(y,w) & _s:2(y,z) & _s:3(y,v) & _s:4(y,y))
...
than :: ((S\N)\(S\N))/N :: \P Q R y.exists w z.(P(w) & Q(z,y) & R(z) & than:1(y,z) & than:2(y,y) & than:3(y,w))
...
that :: ((S\N)\(S\N))/((S\N)\(S\N)) :: \P Q y.exists z.(P(y,z) & Q(y) & that:1(y,y) & that:2(y,z))
that :: ((S\N)\(S\N))/((S\N)\(S\N)) :: \P Q R y.exists z.(P(z,y) & Q(z,y) & R(z) & that:1(y,z) & that:2(y,y))
that :: (N\N)/S :: \P x.(P(x) & TARGET(x))
that :: (N\N)/S :: \P y.(P(y) & that:1(y,y))
that :: (N\N)/S :: \P Q y.exists z.(P(y,z) & Q(y) & that:1(y,y) & that:2(y,z))
that :: (N\N)/(S/N) :: \P Q y.exists z.(P(y,z) & Q(y) & that:1(y,y) & that:2(y,z))
the :: N/N :: \P y.(P(y) & UNIQUE(y))
the :: (((S\N)\(S\N))\((S\N)\(S\N)))/N :: \P Q R y.exists w z.(P(w) & Q(z,y) & R(z) & UNIQUE(y))
...
through :: (N\N)/N :: \P Q y.exists z.(P(z,y) & Q(z) & through:1(y,z) & through:2(y,y))
through :: (S\N)\(S\N) :: \P Q y.exists z.(P(z,y) & Q(z) & through:1(y,z) & through:2(y,y))
through :: PP/N :: \P e.exists y.(P(y) & through:1(e,y))
through :: N/N :: \P y.(P(y) & through:1(y,y))
through :: ((S\N)\(S\N))/N :: \P Q R y.exists w z.(P(w) & Q(z,y) & R(z) & through:1(y,z) & through:2(y,y) & through:3(y,w))
through :: ((S\N)/(S\N))/N :: \P Q R y.exists w z.(P(w) & Q(z,y) & R(z) & through:1(y,z) & through:2(y,y) & through:3(y,w))
...
(N\N)/S :: \P Q y.exists z.(P(y,z) & Q(y) & {0}:1(y,y) & {0}:2(y,z))
...
(S/(S\N))/N :: \P x.(P(x) & TARGET(x))
(S/(S\N))/N :: \P Q e.exists z y.(P(z) & Q(z,y) & {0}:1(e,z) & {0}:2(e,y))
(N\N)/(N\N) :: \x.EQUAL(x,{0})
(N\N)/(N\N) :: \x.{0}(x)
(S/(S/N))/N :: \P x.(P(x) & TARGET(x))
...
((S\N)\(S\N))/N :: \P Q R y.exists w z.(P(w) & Q(z,y) & R(z) & COMPLEMENT(y))
...
(S/(S/N))/(S/(S/N)) :: \P Q Y.exists y w z.(P(y) & Q(w,z) & {0}:1(y,w) & {0}:2(y,z) & {0}:3(y,y))
(S/(S/(S\N)))/(S\N) :: \P x.(P(x) & TARGET(x))
((S/(S\N))/N)/(N/N) :: \P x.(P(x) & TARGET(x))
((S/(S/N))/N)/(N/N) :: \P x.(P(x) & TARGET(x))
((N/N)/(N/N))/(S\N) :: \P Q R y.exists v w.(P(v,w) & Q(y,y) & R(y) & {0}:1(y,y) & {0}:2(y,v) & {0}:3(y,w))
(S/(S/PP))/(S/(S/N)) :: \P Q e.exists w z y.(P(w) & Q(z,y) & {0}:1(e,z) & {0}:2(e,y) & {0}:3(e,w))
((S/(S\N))/N)\(S/(S\N)) :: \P Q R Y.exists y v w z.(P(y) & Q(v) & R(w,z) & {0}:1(y,w) & {0}:2(y,z) & {0}:3(y,v) & {0}:4(y,y))
((S\N)\(S\N))/((S\N)\(S\N)) :: \P Q y.exists z.(P(y,z) & Q(y) & {0}:1(y,y) & {0}:2(y,z))
((S\N)\(S\N))/((S\N)\(S\N)) :: \P Q R y.exists z.(P(z,y) & Q(z,y) & R(z) & {0}:1(y,z) & {0}:2(y,y))
(((S/PP)/((S/PP)/N))/N)/(N/N) :: \P x.(P(x) & TARGET(x))
(((S\N)\(S\N))\((S\N)\(S\N)))/N :: \P Q R y.exists w z.(P(w) & Q(z,y) & R(z) & UNIQUE(y))
